...
<body>
	...
	<table class="table table-bordered" style="text-align: center;">
		...
		<c:forEach items="${list }" var="list">
			<tr onclick="location.href='noticeSelect.do?noticeNo=${list.noticeNo }'">
				<td>${list.noticeNo}</td>
				<td>${list.title }</td>
				<td>${list.writer }</td>
				<td>${list.wrDt}</td>
	...
	<div align="right">
		<button type="button" class="btn btn-primary" onclick="location.href='noticeWriteForm.do'">글등록</button>
		</div>
