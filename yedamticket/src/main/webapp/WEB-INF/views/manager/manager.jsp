	...
	<div class="col-lg-12 grid-margin stretch-card">
		<div class="card">
			<div class="card-body">
				...
				<input type="button" class="btn btn-gradient-primary me-2"
					onclick="location.href='managerForm.do'" value="등록">
				...
				<div class="col-3">
					<div class="input-group mb-3" align="right">
						<select name="searchType" class="btn btn-outline-secondary">
							...
							value="${pageVO.cri.searchName }" class="form-control" aria-label="Text input with dropdown button">
