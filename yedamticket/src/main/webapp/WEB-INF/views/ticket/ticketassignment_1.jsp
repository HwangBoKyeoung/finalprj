								...
								<li class="widthitem">
									<div class="card" style="width: 20rem;">
										<div class="card-body">
											...
											<input type="button" onclick="selectedFnc()"
												class="btn btn-primary" data-toggle="modal"
												data-target="#prInfoModal" value="선택"> <input
												type="button" onclick="selectedFnc2()"
												class="btn btn-primary" data-toggle="modal"
												data-target="#prInfoModal" value="환불">
										</div>
									</div>
								</li>
							</c:if>
	...
	<div id="mv_container" style="position: absolute">
		<div align="center">
			...
			<div id="widthslider" align="center">
							...
							<li class="widthitem">
								<div class="card" style="width: 20rem;">
									<div class="card-body">
										...
										<input type="button" onclick="selectedFnc()"
											class="btn btn-primary" data-toggle="modal"
											data-target="#mrInfoModal" value="선택"> <input
											type="button" onclick="selectedFnc2()" class="btn btn"
											data-toggle="modal" data-target="#mrInfoModal2" value="환불">
									</div>
								</div>
							</li>
						</c:if>
				...
				<div class="modal fade" id="mrInfoModal2">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal"
