...
<div class="section section-images">
              ...
              <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                  <div class="carousel-item active">
                    <img class="d-block" src="resources/users/img/bg1.jpg" alt="First slide">
                    <div class="carousel-caption d-none d-md-block">
                      <h5>Nature, United States</h5>
                    </div>
                  </div>
                  <div class="carousel-item">
                    <img class="d-block" src="resources/users/img/bg3.jpg" alt="Second slide">
                    <div class="carousel-caption d-none d-md-block">
                      <h5>Somewhere Beyond, United States</h5>
                    </div>
                  </div>
                  <div class="carousel-item">
                    <img class="d-block" src="resources/users/img/bg4.jpg" alt="Third slide">
                    <div class="carousel-caption d-none d-md-block">
          ...
          <div class="row">
            <div class="col-lg-6 col-md-12">
              ...
              <!-- <div class="nucleo-container">
							<img src="resources/img/nucleo.svg" alt="">
						</div> -->
      ...
      <div class="section section-signup" style="background-image: url('resources/users/img/bg11.jpg'); background-size: cover; background-position: top center; min-height: 700px;">
        <div class="container">
          <div class="row">
          ...
          <div class="row">
            <div class="col">
              <a href="examples/landing-page.html" target="_blank">
                <img src="resources/users/img/landing.jpg" alt="Image" class="img-raised">
              </a>
              <a href="examples/landing-page.html" class="btn btn-outline-default btn-primary btn-round">View Landing Page</a>
            </div>
            <div class="col">
              <a href="examples/profile-page.html" target="_blank">
                <img src="resources/users/img/profile.jpg" alt="Image" class="img-raised">
              </a>
